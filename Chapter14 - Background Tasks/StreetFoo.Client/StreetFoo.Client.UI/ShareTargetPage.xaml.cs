...
namespace StreetFoo.Client.UI
{
    ...
    /// </summary>
    [ViewModel(typeof(IShareTargetPageViewModel))]
    public sealed partial class ShareTargetPage : StreetFooPage
    {
        ...
        private IShareTargetPageViewModel Model
        {
            get
            {
                return (IShareTargetPageViewModel)this.GetViewModel();
            }
        }
